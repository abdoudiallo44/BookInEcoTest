				...
				<table>
					<tr>
						...
						<td>
							...
							<c:if test="${ EmailAlreadyExists }"><p style="color: red">Cette adresse est déjà utilisée !</p>
							 </c:if> 
						</td>
					</tr>
					<tr>
						...
						<td>
							...
							<c:if test="${ PseudoAlreadyExists }"><p style="color: red">Ce pseudo est déjà utilisé !</p>
							 </c:if> 
						</td>
					</tr>
					<tr>
