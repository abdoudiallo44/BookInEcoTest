...
public class AdresseLivraison extends DbObject {
	...
	public AdresseLivraison(String numEtRueAdresse, int codePostal, String ville,
			String pays) {
		super();
		this.numEtRueAdresse = numEtRueAdresse;
		this.codePostal = codePostal;
	...
	public String toString() {
		return super.toString() + " AdresseLivraison [numEtRueAdresse=" + numEtRueAdresse + ", codePostal=" + codePostal + ", ville="
