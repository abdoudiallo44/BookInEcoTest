...
//		GenericDAO.create(livre);
//	}
//	
//	//@Transactional
//	public List<Livre> readAll(){
//		return GenericDAO.findAll(Livre.class);
//	}
//	
////	@Transactional
...
////	
////	@Transactional
//	public Livre findByKey(String key){
//		return GenericDAO.findById(Livre.class, Integer.parseInt(key));
//	}
//	
//	@Transactional
